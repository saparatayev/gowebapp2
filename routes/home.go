...
func homePostHandler(w http.ResponseWriter, r *http.Request) {
	...
	if count > 0 {
		...
		html += fmt.Sprintf("<th>ID</th> <th>Category</th> <th>Name</th> <th>Price</th> <th>Quantity</th> <th>Total</th>")
		...
		html += fmt.Sprintf("<p class='alert alert-info'>Nothing found for query <strong>%s</strong></p>", search)
	}
